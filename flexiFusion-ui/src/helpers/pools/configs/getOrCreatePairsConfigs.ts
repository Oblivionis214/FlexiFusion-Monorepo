...
export const getPoolConfigsByChains = async (chainsArr: number[] = []) => {
  console.log("getPoolConfigsByChains - input chains:", chainsArr);
  console.log("getPoolConfigsByChains - poolChains:", poolChains);
  const iteratedChains = chainsArr.length ? chainsArr : poolChains;
  console.log("getPoolConfigsByChains - iteratedChains:", iteratedChains);
  console.log("getPoolConfigsByChains - localPoolConfigs:", localPoolConfigs);

  const result = await Promise.allSettled(
    iteratedChains.flatMap(async (chainId) => {
      console.log("getPoolConfigsByChains - processing chainId:", chainId);
      const pairsList = (await fetchPairsList(chainId)) as GraphPairsConfigs;
      console.log("getPoolConfigsByChains - pairsList:", pairsList);

      if (pairsList) {
        const filterPools = filterBlacklistPools(pairsList, chainId);
        console.log("getPoolConfigsByChains - filterPools:", filterPools);
  ...
  console.log("getPoolConfigsByChains - final result:", finalResult);
  return finalResult;
};
