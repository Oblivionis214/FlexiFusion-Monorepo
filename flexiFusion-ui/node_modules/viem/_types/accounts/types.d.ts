...
export type Account<TAddress extends Address = Address> = OneOf<JsonRpcAccount<TAddress> | LocalAccount<string, TAddress>>;
export type AccountSource = Address | CustomSource;
export type CustomSource = {
    address: Address;
    experimental_signAuthMessage?: ((parameters: ToAuthMessageParameters) => Promise<Hash>) | undefined;
    signMessage: ({ message }: {
...
export type PrivateKeyAccount = RequiredBy<LocalAccount<'privateKey'>, 'experimental_signAuthMessage'>;
