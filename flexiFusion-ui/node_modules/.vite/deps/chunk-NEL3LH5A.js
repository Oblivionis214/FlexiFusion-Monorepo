...
var Geo = (
  ...
  function(_super) {
    ...
    function Geo2(name, map2, opt) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && projection) {
...
function setVisualToOption(thisOption, visualArr) {
  ...
  if (thisOption.type === "color") {
    thisOption.parsedVisual = map(visualArr, function(item) {
      ...
      if (!color && import_process.default.env.NODE_ENV !== "production") {
...
//# sourceMappingURL=chunk-NEL3LH5A.js.map
