...
// node_modules/@uniswap/v3-sdk/node_modules/@uniswap/sdk-core/dist/sdk-core.esm.js
init_shim();
...
var Token = function(_BaseCurrency) {
  ...
  function Token2(chainId, address, decimals, symbol, name, bypassChecksum, buyFeeBps, sellFeeBps) {
    ...
    if (buyFeeBps) {
      !buyFeeBps.gte(BigNumber.from(0)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "NON-NEGATIVE FOT FEES") : invariant(false) : void 0;
    }
    if (sellFeeBps) {
      !sellFeeBps.gte(BigNumber.from(0)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "NON-NEGATIVE FOT FEES") : invariant(false) : void 0;
    }
...
var ZERO2 = jsbi_default.BigInt(0);
...
var LiquidityMath = function() {
  ...
  LiquidityMath2.addDelta = function addDelta(x, y) {
    if (jsbi_default.lessThan(y, ZERO2)) {
...
var FullMath = function() {
  ...
  FullMath2.mulDivRoundingUp = function mulDivRoundingUp(a, b, denominator) {
    ...
    if (jsbi_default.notEqual(jsbi_default.remainder(product, denominator), ZERO2))
      result = jsbi_default.add(result, ONE2);
    return result;
  };
  return FullMath2;
}();
var MaxUint160 = jsbi_default.subtract(jsbi_default.exponentiate(jsbi_default.BigInt(2), jsbi_default.BigInt(160)), ONE2);
...
var SqrtPriceMath = function() {
  ...
  SqrtPriceMath2.getAmount0Delta = function getAmount0Delta(sqrtRatioAX96, sqrtRatioBX96, liquidity, roundUp) {
    ...
    return roundUp ? FullMath.mulDivRoundingUp(FullMath.mulDivRoundingUp(numerator1, numerator2, sqrtRatioBX96), ONE2, sqrtRatioAX96) : jsbi_default.divide(jsbi_default.divide(jsbi_default.multiply(numerator1, numerator2), sqrtRatioBX96), sqrtRatioAX96);
  };
  ...
  SqrtPriceMath2.getNextSqrtPriceFromInput = function getNextSqrtPriceFromInput(sqrtPX96, liquidity, amountIn, zeroForOne) {
    !jsbi_default.greaterThan(sqrtPX96, ZERO2) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
    !jsbi_default.greaterThan(liquidity, ZERO2) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
  ...
  SqrtPriceMath2.getNextSqrtPriceFromAmount0RoundingUp = function getNextSqrtPriceFromAmount0RoundingUp(sqrtPX96, liquidity, amount, add) {
    if (jsbi_default.equal(amount, ZERO2))
      return sqrtPX96;
    var numerator1 = jsbi_default.leftShift(liquidity, jsbi_default.BigInt(96));
    if (add) {
      ...
      return FullMath.mulDivRoundingUp(numerator1, ONE2, jsbi_default.add(jsbi_default.divide(numerator1, sqrtPX96), amount));
    } else {
      var _product = multiplyIn256(amount, sqrtPX96);
      !jsbi_default.equal(jsbi_default.divide(_product, amount), sqrtPX96) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
      !jsbi_default.greaterThan(numerator1, _product) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
  ...
  SqrtPriceMath2.getNextSqrtPriceFromAmount1RoundingDown = function getNextSqrtPriceFromAmount1RoundingDown(sqrtPX96, liquidity, amount, add) {
    if (add) {
      ...
      !jsbi_default.greaterThan(sqrtPX96, _quotient) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
...
var SwapMath = function() {
  ...
  SwapMath2.computeSwapStep = function computeSwapStep(sqrtRatioCurrentX96, sqrtRatioTargetX96, liquidity, amountRemaining, feePips) {
    ...
    var exactIn = jsbi_default.greaterThanOrEqual(amountRemaining, ZERO2);
    if (exactIn) {
      var amountRemainingLessFee = jsbi_default.divide(jsbi_default.multiply(amountRemaining, jsbi_default.subtract(MAX_FEE, jsbi_default.BigInt(feePips))), MAX_FEE);
    ...
    if (exactIn && jsbi_default.notEqual(returnValues.sqrtRatioNextX96, sqrtRatioTargetX96)) {
      ...
      returnValues.feeAmount = FullMath.mulDivRoundingUp(returnValues.amountIn, jsbi_default.BigInt(feePips), jsbi_default.subtract(MAX_FEE, jsbi_default.BigInt(feePips)));
    }
    return [returnValues.sqrtRatioNextX96, returnValues.amountIn, returnValues.amountOut, returnValues.feeAmount];
  };
  return SwapMath2;
}();
var TWO2 = jsbi_default.BigInt(2);
var POWERS_OF_2 = [128, 64, 32, 16, 8, 4, 2, 1].map(function(pow) {
  return [pow, jsbi_default.exponentiate(TWO2, jsbi_default.BigInt(pow))];
});
function mostSignificantBit(x) {
  !jsbi_default.greaterThan(x, ZERO2) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "ZERO") : invariant(false) : void 0;
  !jsbi_default.lessThanOrEqual(x, MaxUint256) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "MAX") : invariant(false) : void 0;
  var msb = 0;
...
var TickMath = function() {
  ...
  TickMath2.getSqrtRatioAtTick = function getSqrtRatioAtTick(tick) {
    !(tick >= TickMath2.MIN_TICK && tick <= TickMath2.MAX_TICK && Number.isInteger(tick)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK") : invariant(false) : void 0;
    ...
    return jsbi_default.greaterThan(jsbi_default.remainder(ratio, Q32), ZERO2) ? jsbi_default.add(jsbi_default.divide(ratio, Q32), ONE2) : jsbi_default.divide(ratio, Q32);
  };
  TickMath2.getTickAtSqrtRatio = function getTickAtSqrtRatio(sqrtRatioX96) {
    !(jsbi_default.greaterThanOrEqual(sqrtRatioX96, TickMath2.MIN_SQRT_RATIO) && jsbi_default.lessThan(sqrtRatioX96, TickMath2.MAX_SQRT_RATIO)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "SQRT_RATIO") : invariant(false) : void 0;
...
var NoTickDataProvider = function() {
  ...
  _proto.getTick = function() {
    var _getTick = _asyncToGenerator(runtime_1.mark(function _callee(_tick) {
  ...
  _proto.nextInitializedTickWithinOneWord = function() {
    var _nextInitializedTickWithinOneWord = _asyncToGenerator(runtime_1.mark(function _callee2(_tick, _lte, _tickSpacing) {
...
var TickList = function() {
  ...
  TickList2.validateList = function validateList(ticks, tickSpacing) {
    !(tickSpacing > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK_SPACING_NONZERO") : invariant(false) : void 0;
    !ticks.every(function(_ref) {
      var index = _ref.index;
      return index % tickSpacing === 0;
    }) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK_SPACING") : invariant(false) : void 0;
    ...
    }, ZERO2), ZERO2) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "ZERO_NET") : invariant(false) : void 0;
    !isSorted(ticks, tickComparator) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "SORTED") : invariant(false) : void 0;
  };
  TickList2.isBelowSmallest = function isBelowSmallest(ticks, tick) {
    !(ticks.length > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "LENGTH") : invariant(false) : void 0;
  ...
  TickList2.getTick = function getTick(ticks, index) {
    ...
    !(tick.index === index) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "NOT_CONTAINED") : invariant(false) : void 0;
    return tick;
  };
  TickList2.binarySearch = function binarySearch(ticks, tick) {
    !!this.isBelowSmallest(ticks, tick) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "BELOW_SMALLEST") : invariant(false) : void 0;
    var l = 0;
  ...
  TickList2.nextInitializedTick = function nextInitializedTick(ticks, tick, lte) {
    if (lte) {
      !!TickList2.isBelowSmallest(ticks, tick) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "BELOW_SMALLEST") : invariant(false) : void 0;
      ...
      !!this.isAtOrAboveLargest(ticks, tick) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "AT_OR_ABOVE_LARGEST") : invariant(false) : void 0;
...
function nearestUsableTick(tick, tickSpacing) {
  !(Number.isInteger(tick) && Number.isInteger(tickSpacing)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "INTEGERS") : invariant(false) : void 0;
  !(tickSpacing > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK_SPACING") : invariant(false) : void 0;
  !(tick >= TickMath.MIN_TICK && tick <= TickMath.MAX_TICK) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK_BOUND") : invariant(false) : void 0;
...
function subIn256(x, y) {
  ...
  if (jsbi_default.lessThan(difference, ZERO2)) {
...
var Tick = function Tick2(_ref) {
  ...
  !(index >= TickMath.MIN_TICK && index <= TickMath.MAX_TICK) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK") : invariant(false) : void 0;
  this.index = index;
...
var TickListDataProvider = function() {
  ...
  _proto.getTick = function() {
    var _getTick = _asyncToGenerator(runtime_1.mark(function _callee(tick) {
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
  ...
  _proto.nextInitializedTickWithinOneWord = function() {
    var _nextInitializedTickWithinOneWord = _asyncToGenerator(runtime_1.mark(function _callee2(tick, lte, tickSpacing) {
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
...
var Pool = function() {
  function Pool2(tokenA, tokenB, fee, sqrtRatioX96, liquidity, tickCurrent, ticks) {
    ...
    !(Number.isInteger(fee) && fee < 1e6) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "FEE") : invariant(false) : void 0;
    ...
    !(jsbi_default.greaterThanOrEqual(jsbi_default.BigInt(sqrtRatioX96), tickCurrentSqrtRatioX96) && jsbi_default.lessThanOrEqual(jsbi_default.BigInt(sqrtRatioX96), nextTickSqrtRatioX96)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "PRICE_BOUNDS") : invariant(false) : void 0;
  ...
  _proto.priceOf = function priceOf(token) {
    !this.involvesToken(token) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TOKEN") : invariant(false) : void 0;
    return token.equals(this.token0) ? this.token0Price : this.token1Price;
  };
  _proto.getOutputAmount = function() {
    var _getOutputAmount = _asyncToGenerator(runtime_1.mark(function _callee(inputAmount, sqrtPriceLimitX96) {
      var zeroForOne, _yield$this$swap, outputAmount, sqrtRatioX96, liquidity, tickCurrent, outputToken;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              !this.involvesToken(inputAmount.currency) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TOKEN") : invariant(false) : void 0;
  ...
  _proto.getInputAmount = function() {
    var _getInputAmount = _asyncToGenerator(runtime_1.mark(function _callee2(outputAmount, sqrtPriceLimitX96) {
      var zeroForOne, _yield$this$swap2, inputAmount, sqrtRatioX96, liquidity, tickCurrent, inputToken;
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              !(outputAmount.currency.isToken && this.involvesToken(outputAmount.currency)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TOKEN") : invariant(false) : void 0;
  ...
  _proto.swap = function() {
    var _swap = _asyncToGenerator(runtime_1.mark(function _callee3(zeroForOne, amountSpecified, sqrtPriceLimitX96) {
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              if (!sqrtPriceLimitX96)
                sqrtPriceLimitX96 = zeroForOne ? jsbi_default.add(TickMath.MIN_SQRT_RATIO, ONE2) : jsbi_default.subtract(TickMath.MAX_SQRT_RATIO, ONE2);
              if (zeroForOne) {
                !jsbi_default.greaterThan(sqrtPriceLimitX96, TickMath.MIN_SQRT_RATIO) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "RATIO_MIN") : invariant(false) : void 0;
                !jsbi_default.lessThan(sqrtPriceLimitX96, this.sqrtRatioX96) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "RATIO_CURRENT") : invariant(false) : void 0;
              } else {
                !jsbi_default.lessThan(sqrtPriceLimitX96, TickMath.MAX_SQRT_RATIO) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "RATIO_MAX") : invariant(false) : void 0;
                !jsbi_default.greaterThan(sqrtPriceLimitX96, this.sqrtRatioX96) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "RATIO_CURRENT") : invariant(false) : void 0;
              }
              exactInput = jsbi_default.greaterThanOrEqual(amountSpecified, ZERO2);
              state = {
            ...
            case 4:
              if (!(jsbi_default.notEqual(state.amountSpecifiedRemaining, ZERO2) && state.sqrtPriceX96 != sqrtPriceLimitX96)) {
                _context3.next = 35;
                break;
              }
              step = {};
            ...
            case 9:
              ...
              _SwapMath$computeSwap = SwapMath.computeSwapStep(state.sqrtPriceX96, (zeroForOne ? jsbi_default.lessThan(step.sqrtPriceNextX96, sqrtPriceLimitX96) : jsbi_default.greaterThan(step.sqrtPriceNextX96, sqrtPriceLimitX96)) ? sqrtPriceLimitX96 : step.sqrtPriceNextX96, state.liquidity, state.amountSpecifiedRemaining, this.fee);
            ...
            case 25:
              ...
              if (zeroForOne)
                liquidityNet = jsbi_default.multiply(liquidityNet, NEGATIVE_ONE);
...
var Position = function() {
  function Position2(_ref) {
    ...
    !(tickLower < tickUpper) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK_ORDER") : invariant(false) : void 0;
    !(tickLower >= TickMath.MIN_TICK && tickLower % pool.tickSpacing === 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK_LOWER") : invariant(false) : void 0;
    !(tickUpper <= TickMath.MAX_TICK && tickUpper % pool.tickSpacing === 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TICK_UPPER") : invariant(false) : void 0;
    this.pool = pool;
  ...
  _proto.mintAmountsWithSlippage = function mintAmountsWithSlippage(slippageTolerance) {
    ...
    var positionThatWillBeCreated = Position2.fromAmounts(_extends2({
      pool: this.pool,
...
var Route = function() {
  function Route2(pools, input, output) {
    this._midPrice = null;
    !(pools.length > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "POOLS") : invariant(false) : void 0;
    var chainId = pools[0].chainId;
    var allOnSameChain = pools.every(function(pool2) {
      return pool2.chainId === chainId;
    });
    !allOnSameChain ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "CHAIN_IDS") : invariant(false) : void 0;
    var wrappedInput = input.wrapped;
    !pools[0].involvesToken(wrappedInput) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "INPUT") : invariant(false) : void 0;
    !pools[pools.length - 1].involvesToken(output.wrapped) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "OUTPUT") : invariant(false) : void 0;
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(pools.entries()), _step; !(_step = _iterator()).done; ) {
      ...
      !(currentInputToken.equals(pool.token0) || currentInputToken.equals(pool.token1)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "PATH") : invariant(false) : void 0;
...
function tradeComparator(a, b) {
  !a.inputAmount.currency.equals(b.inputAmount.currency) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "INPUT_CURRENCY") : invariant(false) : void 0;
  !a.outputAmount.currency.equals(b.outputAmount.currency) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "OUTPUT_CURRENCY") : invariant(false) : void 0;
...
var Trade = function() {
  function Trade2(_ref) {
    ...
    }) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "INPUT_CURRENCY_MATCH") : invariant(false) : void 0;
    !routes.every(function(_ref3) {
      var route2 = _ref3.route;
      return outputCurrency.wrapped.equals(route2.output.wrapped);
    }) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "OUTPUT_CURRENCY_MATCH") : invariant(false) : void 0;
    ...
    !(numPools == poolAddressSet.size) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "POOLS_DUPLICATED") : invariant(false) : void 0;
    this.swaps = routes;
    this.tradeType = tradeType;
  }
  Trade2.exactIn = function() {
    var _exactIn = _asyncToGenerator(runtime_1.mark(function _callee(route, amountIn) {
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
  ...
  Trade2.exactOut = function() {
    var _exactOut = _asyncToGenerator(runtime_1.mark(function _callee2(route, amountOut) {
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
  ...
  Trade2.fromRoute = function() {
    var _fromRoute = _asyncToGenerator(runtime_1.mark(function _callee3(route, amount, tradeType) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              !amount.currency.equals(route.input) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "INPUT") : invariant(false) : void 0;
            ...
            case 15:
              ...
              break;
            case 19:
              !amount.currency.equals(route.output) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "OUTPUT") : invariant(false) : void 0;
  ...
  Trade2.fromRoutes = function() {
    var _fromRoutes = _asyncToGenerator(runtime_1.mark(function _callee4(routes, tradeType) {
  ...
  Trade2.createUncheckedTrade = function createUncheckedTrade(constructorArguments) {
    return new Trade2(_extends2({}, constructorArguments, {
      routes: [{
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance, amountOut) {
    ...
    !!slippageTolerance.lessThan(ZERO2) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "SLIPPAGE_TOLERANCE") : invariant(false) : void 0;
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      return amountOut;
    } else {
      var slippageAdjustedAmountOut = new Fraction(ONE2).add(slippageTolerance).invert().multiply(amountOut.quotient).quotient;
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance, amountIn) {
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      var slippageAdjustedAmountIn = new Fraction(ONE2).add(slippageTolerance).multiply(amountIn.quotient).quotient;
  ...
  Trade2.bestTradeExactIn = function() {
    var _bestTradeExactIn = _asyncToGenerator(runtime_1.mark(function _callee5(pools, currencyAmountIn, currencyOut, _temp, currentPools, nextAmountIn, bestTrades) {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              !(pools.length > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "POOLS") : invariant(false) : void 0;
              !(maxHops > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "MAX_HOPS") : invariant(false) : void 0;
              !(currencyAmountIn === nextAmountIn || currentPools.length > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "INVALID_RECURSION") : invariant(false) : void 0;
  ...
  Trade2.bestTradeExactOut = function() {
    var _bestTradeExactOut = _asyncToGenerator(runtime_1.mark(function _callee6(pools, currencyIn, currencyAmountOut, _temp2, currentPools, nextAmountOut, bestTrades) {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              !(pools.length > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "POOLS") : invariant(false) : void 0;
              !(maxHops > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "MAX_HOPS") : invariant(false) : void 0;
              !(currencyAmountOut === nextAmountOut || currentPools.length > 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "INVALID_RECURSION") : invariant(false) : void 0;
  ...
  _createClass2(Trade2, [{
    key: "route",
    get: function get() {
      !(this.swaps.length == 1) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "MULTIPLE_ROUTES") : invariant(false) : void 0;
...
var NonfungiblePositionManager = function() {
  ...
  NonfungiblePositionManager2.addCallParameters = function addCallParameters(position, options) {
    !jsbi_default.greaterThan(position.liquidity, ZERO2) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "ZERO_LIQUIDITY") : invariant(false) : void 0;
    var calldatas = [];
    ...
    if (options.useNative) {
      ...
      !(position.pool.token0.equals(wrapped) || position.pool.token1.equals(wrapped)) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "NO_WETH") : invariant(false) : void 0;
      var wrappedValue = position.pool.token0.equals(wrapped) ? amount0Desired : amount1Desired;
      if (jsbi_default.greaterThan(wrappedValue, ZERO2)) {
  ...
  NonfungiblePositionManager2.removeCallParameters = function removeCallParameters(position, options) {
    ...
    !jsbi_default.greaterThan(partialPosition.liquidity, ZERO2) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "ZERO_LIQUIDITY") : invariant(false) : void 0;
    ...
    calldatas.push.apply(calldatas, NonfungiblePositionManager2.encodeCollect(_extends2({
      tokenId: toHex(options.tokenId),
    ...
    if (options.liquidityPercentage.equalTo(ONE2)) {
      ...
      !(options.burnToken !== true) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "CANNOT_BURN") : invariant(false) : void 0;
    }
    return {
      calldata: Multicall.encodeMulticall(calldatas),
      value: toHex(0)
...
var SwapQuoter = function() {
  ...
  SwapQuoter2.quoteCallParameters = function quoteCallParameters(route, amount, tradeType, options) {
    ...
    if (singleHop) {
      ...
      var v2QuoteParams = _extends2({}, baseQuoteParams, tradeType == TradeType.EXACT_INPUT ? {
      ...
      var _options2;
      !(((_options2 = options) == null ? void 0 : _options2.sqrtPriceLimitX96) === void 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "MULTIHOP_PRICE_LIMIT") : invariant(false) : void 0;
...
var SwapRouter = function() {
  ...
  SwapRouter2.swapCallParameters = function swapCallParameters(trades, options) {
    ...
    }) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TOKEN_IN_DIFF") : invariant(false) : void 0;
    !trades.every(function(trade2) {
      return trade2.outputAmount.currency.wrapped.equals(tokenOut);
    }) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "TOKEN_OUT_DIFF") : invariant(false) : void 0;
    var calldatas = [];
    ...
    if (options.inputTokenPermit) {
      !sampleTrade.inputAmount.currency.isToken ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "NON_TOKEN_PERMIT") : invariant(false) : void 0;
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(trades), _step; !(_step = _iterator()).done; ) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(trade.swaps), _step2; !(_step2 = _iterator2()).done; ) {
        ...
        if (singleHop) {
          ...
          !(options.sqrtPriceLimitX96 === void 0) ? import_process.default.env.NODE_ENV !== "production" ? invariant(false, "MULTIHOP_PRICE_LIMIT") : invariant(false) : void 0;
