...
function findComponentHighDownDispatchers(componentMainType, componentIndex, name, api) {
  ...
  for (var i = 0; i < dispatchers.length; i++) {
    if (import_process.default.env.NODE_ENV !== "production" && !isHighDownDispatcher(dispatchers[i])) {
...
function handleGlobalMouseOverForHighDown(dispatcher, e2, api) {
  if (import_process.default.env.NODE_ENV !== "production" && !isHighDownDispatcher(dispatcher)) {
    error("param should be highDownDispatcher");
  }
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-IJPWFMTJ.js.map
