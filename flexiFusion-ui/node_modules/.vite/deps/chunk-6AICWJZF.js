import {
  ...
  init_lib10 as init_lib24,
  init_lib11 as init_lib25,
  init_lib12 as init_lib26,
  init_lib2 as init_lib16,
  init_lib3 as init_lib17,
  init_lib4 as init_lib18,
  init_lib5 as init_lib19,
  init_lib6 as init_lib20,
  init_lib7 as init_lib21,
  init_lib8 as init_lib22,
  init_lib9 as init_lib23,
  isValidMnemonic,
  mnemonicToEntropy,
  mnemonicToSeed,
  parse,
...
import {
  ...
  init_lib6 as init_lib12,
  init_lib7 as init_lib13,
  init_lib8 as init_lib14,
  isValidName,
...
var logger2, homestead, ropsten, classicMordor, networks;
...
var import_bech32, __awaiter2, logger4, MAX_CCIP_REDIRECTS, PollableEvents, Event, coinInfos, matcherIpfs, matchers, Resolver, defaultFormatter, nextPollId, BaseProvider;
    ...
    Resolver = class {
      ...
      _getAddress(coinType, hexBytes) {
        ...
        if (coinInfo.prefix != null) {
          ...
          if (version5 >= 0 && bytes.length === 2 + length && length >= 1 && length <= 75) {
            const words = import_bech32.default.toWords(bytes.slice(2));
            words.unshift(version5);
...
var __awaiter3, logger5, errorGas, _constructorGuard, JsonRpcSigner, UncheckedJsonRpcSigner, allowedTransactionKeys2, JsonRpcProvider;
...
var __awaiter4, logger6, NextId, WebSocketProvider;
...
var __awaiter5, logger7, StaticJsonRpcProvider, UrlJsonRpcProvider;
...
var __awaiter6, logger10, CloudflareProvider;
...
var __awaiter7, logger11, EtherscanProvider;
...
var __awaiter8, logger12, nextRid, ForwardErrors, ForwardProperties, FallbackProvider;
...
var logger16, _nextId, Web3Provider;
...
function getDefaultProvider(network, options) {
  ...
  if (!n || !n._defaultProvider) {
    logger17.throwError("unsupported getDefaultProvider network", Logger.errors.NETWORK_ERROR, {
...
export {
  ...
  logger18 as logger,
  ethers_exports,
  lib_exports5 as lib_exports2,
  init_lib30 as init_lib
};
//# sourceMappingURL=chunk-6AICWJZF.js.map
