...
function installModule(store, rootState, path, module, hot) {
  ...
  if (module.namespaced) {
    if (store._modulesNamespaceMap[namespace] && import_process.default.env.NODE_ENV !== "production") {
  ...
  var local = {
    dispatch: noNamespace ? store.dispatch : function(_type, _payload, _options) {
      ...
      if (!options || !options.root) {
        type = namespace + type;
        if (import_process.default.env.NODE_ENV !== "production" && !store._actions[type]) {
    ...
    commit: noNamespace ? store.commit : function(_type, _payload, _options) {
      ...
      if (!options || !options.root) {
        type = namespace + type;
        if (import_process.default.env.NODE_ENV !== "production" && !store._mutations[type]) {
...
Store.prototype.install = function install(app, injectKey) {
  ...
  var useDevtools = this._devtools !== void 0 ? this._devtools : import_process.default.env.NODE_ENV !== "production" || __VUE_PROD_DEVTOOLS__;
  if (useDevtools) {
...
Store.prototype.commit = function commit(_type, _payload, _options) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && options && options.silent) {
    console.warn(
...
var mapState = normalizeNamespace(function(namespace, states) {
  var res = {};
  if (import_process.default.env.NODE_ENV !== "production" && !isValidMap(states)) {
...
var mapMutations = normalizeNamespace(function(namespace, mutations) {
  var res = {};
  if (import_process.default.env.NODE_ENV !== "production" && !isValidMap(mutations)) {
...
var mapGetters = normalizeNamespace(function(namespace, getters) {
  var res = {};
  if (import_process.default.env.NODE_ENV !== "production" && !isValidMap(getters)) {
  ...
  normalizeMap(getters).forEach(function(ref) {
    ...
    res[key] = function mappedGetter() {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && !(val in this.$store.getters)) {
...
var mapActions = normalizeNamespace(function(namespace, actions) {
  var res = {};
  if (import_process.default.env.NODE_ENV !== "production" && !isValidMap(actions)) {
...
function getModuleByNamespace(store, helper, namespace) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && !module) {
