...
function getAction(client, action, name) {
  return (params) => {
    var _a, _b;
    return ((_a = client[action.name]) == null ? void 0 : _a.call(client, params)) ?? ((_b = client[name]) == null ? void 0 : _b.call(client, params)) ?? action(client, params);
  };
}
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-W67OM2UH.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash, signature }) {
  ...
  if (v === 0 || v === 1)
    v += 27;
  const { secp256k1: secp256k12 } = await import("./secp256k1-LLU4XXQK.js");
...
//# sourceMappingURL=chunk-FWDL44ZR.js.map
