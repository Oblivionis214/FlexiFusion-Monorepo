import {
  require_browser
} from "./chunk-JCS4YR73.js";
import {
  proxy,
  ref,
  snapshot,
  subscribe
} from "./chunk-7FYQG7JA.js";
import {
  require_react
...
// node_modules/@web3modal/ui/dist/esm/src/assets/svg/convert-input-mask-bottom.js
init_shim();
...
(global3.litHtmlVersions ?? (global3.litHtmlVersions = [])).push("3.1.3");
...
// node_modules/@web3modal/ui/dist/esm/src/assets/svg/convert-input-mask-bottom.js
var convertInputMaskBottomSvg = svg`<svg class="input_mask" width="328" height="100" viewBox="0 0 328 100" fill="none">
...
// node_modules/@web3modal/ui/dist/esm/src/assets/svg/convert-input-mask-top.js
init_shim();
var convertInputMaskTopSvg = svg`<svg class="input_mask" width="328" height="100" viewBox="0 0 328 100" fill="none">
...
WuiIconLink.styles = [resetStyles, elementStyles, colorStyles, styles_default27];
__decorate27([
  property()
...
WuiInputElement.styles = [resetStyles, elementStyles, styles_default28];
__decorate28([
  property()
], WuiInputElement.prototype, "icon", void 0);
WuiInputElement = __decorate28([
...
WuiInputNumeric.styles = [resetStyles, elementStyles, styles_default29];
__decorate29([
  property({ type: Boolean })
...
WuiLink.styles = [resetStyles, elementStyles, styles_default30];
__decorate30([
  property({ type: Boolean })
...
WuiListItem.styles = [resetStyles, elementStyles, styles_default31];
__decorate31([
  property()
...
WuiTransactionVisual.styles = [styles_default32];
__decorate32([
  property()
...
WuiTransactionVisual = __decorate32([
...
WuiTransactionListItem.styles = [resetStyles, styles_default33];
__decorate33([
  property()
...
WuiTransactionListItem = __decorate33([
...
WuiTransactionListItemLoader.styles = [resetStyles, styles_default34];
WuiTransactionListItemLoader = __decorate34([
...
WuiTag.styles = [resetStyles, styles_default35];
__decorate35([
  property()
...
WuiListWallet.styles = [resetStyles, elementStyles, styles_default36];
__decorate36([
  property({ type: Array })
...
WuiLogo.styles = [resetStyles, styles_default37];
__decorate37([
  property()
], WuiLogo.prototype, "logo", void 0);
WuiLogo = __decorate37([
...
WuiLogoSelect.styles = [resetStyles, elementStyles, styles_default38];
__decorate38([
  property()
...
WuiNetworkButton.styles = [resetStyles, elementStyles, styles_default39];
__decorate39([
  property()
...
WuiOtp.styles = [resetStyles, styles_default40];
__decorate40([
  property({ type: Number })
...
WuiQrCode.styles = [resetStyles, styles_default41];
__decorate41([
  property()
...
WuiSearchBar.styles = [resetStyles, styles_default42];
WuiSearchBar = __decorate42([
...
WuiSnackbar.styles = [resetStyles, styles_default43];
__decorate43([
  property()
...
WuiTabs.styles = [resetStyles, elementStyles, styles_default44];
__decorate44([
  property({ type: Array })
...
WuiTokenButton.styles = [resetStyles, elementStyles, styles_default45];
__decorate45([
  property()
...
WuiTooltip.styles = [resetStyles, elementStyles, styles_default46];
__decorate46([
  property()
...
WuiTooltipSelect.styles = [resetStyles, elementStyles, styles_default47];
__decorate47([
  property()
...
function clone(configObject) {
  ...
  BigNumber2.random = function() {
    ...
    return function(dp) {
      var a2, b, e, k, v, i = 0, c = [], rand = new BigNumber2(ONE);
      if (dp == null)
        dp = DECIMAL_PLACES;
      else
        intCheck(dp, 0, MAX);
...
function coeffToString(a2) {
  var s, z, i = 1, j = a2.length, r = a2[0] + "";
  for (; i < j; ) {
    s = a2[i++] + "";
    z = LOG_BASE - s.length;
    for (; z--; s = "0" + s)
...
var NumberUtil = {
  ...
  multiply(a2, b) {
    ...
    const aBigNumber = new bignumber_default(a2);
...
var WuiTokenListItem = class WuiTokenListItem2 extends LitElement {
  ...
  render() {
    var _a5;
    const value = (_a5 = NumberUtil.multiply(this.price, this.amount)) == null ? void 0 : _a5.toFixed(3);
    return html`
      <wui-flex alignItems="center">
        ${this.visualTemplate()}
        <wui-flex flexDirection="column" gap="3xs">
...
// node_modules/@web3modal/core/dist/esm/src/controllers/ConvertController.js
init_shim();
...
var import_shim245 = __toESM(require_shim(), 1);
var { use } = import_react.default;
var { useSyncExternalStore } = import_shim245.default;
...
var EventsController = {
  ...
  sendEvent(data) {
    state4.timestamp = Date.now();
    state4.data = data;
    if (OptionsController.state.enableAnalytics) {
      EventsController._sendAnalyticsEvent(state4);
    }
  }
};
...
// node_modules/@web3modal/core/dist/esm/src/utils/ConvertApiUtil.js
init_shim();
...
var NetworkController = {
  ...
  _getClient() {
    ...
    return state8._client;
  },
  setClient(client) {
    state8._client = ref(client);
  },
  setCaipNetwork(caipNetwork) {
    state8.caipNetwork = caipNetwork;
  ...
  setDefaultCaipNetwork(caipNetwork) {
    state8.caipNetwork = caipNetwork;
    PublicStateController.set({ selectedNetworkId: caipNetwork == null ? void 0 : caipNetwork.id });
    state8.isDefaultCaipNetwork = true;
  },
  setRequestedCaipNetworks(requestedNetworks) {
    state8.requestedCaipNetworks = requestedNetworks;
  },
  setAllowUnsupportedChain(allowUnsupportedChain) {
    state8.allowUnsupportedChain = allowUnsupportedChain;
  },
  setSmartAccountEnabledNetworks(smartAccountEnabledNetworks) {
    state8.smartAccountEnabledNetworks = smartAccountEnabledNetworks;
  },
  getRequestedCaipNetworks() {
    const { approvedCaipNetworkIds, requestedCaipNetworks } = state8;
  ...
  async getApprovedCaipNetworksData() {
    ...
    state8.supportsAllNetworks = data.supportsAllNetworks;
    state8.approvedCaipNetworkIds = data.approvedCaipNetworkIds;
  },
  async switchActiveNetwork(network) {
    await this._getClient().switchCaipNetwork(network);
    state8.caipNetwork = network;
    if (network) {
      EventsController.sendEvent({
        type: "track",
  ...
  checkIfSupportedNetwork() {
    var _a5;
    state8.isUnsupportedChain = !((_a5 = state8.requestedCaipNetworks) == null ? void 0 : _a5.some((network) => {
      var _a6;
      return network.id === ((_a6 = state8.caipNetwork) == null ? void 0 : _a6.id);
    }));
    if (state8.isUnsupportedChain) {
      this.showUnsupportedChainUI();
    }
  },
  checkIfSmartAccountEnabled() {
    var _a5, _b3;
    const networkId = NetworkUtil.caipNetworkIdToNumber((_a5 = state8.caipNetwork) == null ? void 0 : _a5.id);
    if (!networkId) {
      return false;
    }
    return Boolean((_b3 = state8.smartAccountEnabledNetworks) == null ? void 0 : _b3.includes(networkId));
  },
  resetNetwork() {
    if (!state8.isDefaultCaipNetwork) {
      state8.caipNetwork = void 0;
    }
    state8.approvedCaipNetworkIds = void 0;
    state8.supportsAllNetworks = true;
    state8.smartAccountEnabledNetworks = [];
  },
...
var ConvertApiUtil = {
  async getTokenList() {
    ...
    const response = await BlockchainApiController.fetchConvertTokens({
      chainId: (_a5 = NetworkController.state.caipNetwork) == null ? void 0 : _a5.id,
      projectId: OptionsController.state.projectId
    });
  ...
  mapBalancesToConvertTokens(balances) {
    return balances.map((token) => {
      ...
      return {
        symbol: token.symbol,
        name: token.name,
        address: (token == null ? void 0 : token.address) ? token.address : `${(_a5 = NetworkController.state.caipNetwork) == null ? void 0 : _a5.id}:${ConstantsUtil.NATIVE_TOKEN_ADDRESS}`,
...
var RouterController = {
  ...
  popTransactionStack(cancel) {
    ...
    if (cancel) {
      this.goBack();
      (_a5 = action == null ? void 0 : action.onCancel) == null ? void 0 : _a5.call(action);
    } else {
      if (action.goBack) {
        this.goBack();
      } else if (action.view) {
...
var ConvertController = {
  ...
  getParams() {
    ...
    const networkAddress = `${(_a5 = NetworkController.state.caipNetwork) == null ? void 0 : _a5.id}:${ConstantsUtil.NATIVE_TOKEN_ADDRESS}`;
    if (!address) {
    ...
    return {
      ...
      sourceTokenAddress: (_b3 = state10.sourceToken) == null ? void 0 : _b3.address,
      toTokenAddress: (_c = state10.toToken) == null ? void 0 : _c.address,
      toTokenAmount: state10.toTokenAmount,
      toTokenDecimals: (_d = state10.toToken) == null ? void 0 : _d.decimals,
      sourceTokenAmount: state10.sourceTokenAmount,
      sourceTokenDecimals: (_e = state10.sourceToken) == null ? void 0 : _e.decimals
    };
  },
  setLoading(loading) {
  ...
  switchTokens() {
    ...
    this.setSourceTokenAmount(state10.toTokenAmount || "0");
    ConvertController.convertTokens();
  },
  resetTokens() {
    state10.tokens = void 0;
    state10.popularTokens = void 0;
    state10.myTokensWithBalance = void 0;
    state10.initialized = false;
  },
  resetValues() {
    var _a5;
    const { networkAddress } = this.getParams();
    const networkToken = (_a5 = state10.tokens) == null ? void 0 : _a5.find((token) => token.address === networkAddress);
    this.setSourceToken(networkToken);
    state10.sourceTokenPriceInUSD = state10.tokensPriceMap[networkAddress] || 0;
    state10.sourceTokenAmount = "0";
    this.setToToken(void 0);
    state10.gasPriceInUSD = 0;
  },
  clearError() {
  ...
  async getAddressPrice(address) {
    ...
    const symbol = (_a5 = allTokens == null ? void 0 : allTokens.find((token) => token.address === address)) == null ? void 0 : _a5.symbol;
    const price = ((_b3 = fungibles.find((p2) => p2.symbol === symbol)) == null ? void 0 : _b3.price) || "0";
  ...
  async getNetworkTokenPrice() {
    ...
    const token = (_a5 = response.fungibles) == null ? void 0 : _a5[0];
    const price = (token == null ? void 0 : token.price) || "0";
  ...
  setBalances(balances) {
    ...
    state10.myTokensWithBalance = balances;
  ...
  async refreshConvertValues() {
    ...
    if (fromAddress && toTokenAddress && toTokenDecimals && !state10.loading) {
  ...
  calculateGasPriceInUSD(gas, gasPrice) {
    ...
    const networkPriceInUSD = NumberUtil.bigNumber(state10.networkPrice);
  ...
  calculatePriceImpact(toTokenAmount, gasPriceInUSD) {
    const sourceTokenAmount = state10.sourceTokenAmount;
    const sourceTokenPrice = state10.sourceTokenPriceInUSD;
    const toTokenPrice = state10.toTokenPriceInUSD;
  ...
  calculateMaxSlippage() {
    const slippageToleranceDecimal = NumberUtil.bigNumber(state10.slippage).dividedBy(100);
    const maxSlippageAmount = NumberUtil.multiply(state10.sourceTokenAmount, slippageToleranceDecimal);
  ...
  async getTransaction() {
    ...
    if (hasAllowance) {
      ...
      state10.convertTransaction = transaction;
    } else {
      state10.convertTransaction = void 0;
  ...
  getToAmount() {
    ...
    const toTokenConvertedAmount = state10.sourceTokenPriceInUSD && state10.toTokenPriceInUSD && state10.sourceTokenAmount ? NumberUtil.bigNumber(state10.sourceTokenAmount).multipliedBy(state10.sourceTokenPriceInUSD).dividedBy(state10.toTokenPriceInUSD) : NumberUtil.bigNumber(0);
  ...
  async sendTransactionForApproval(data) {
    ...
    state10.transactionLoading = true;
    ...
    try {
      ...
      state10.approvalTransaction = void 0;
      state10.transactionLoading = false;
      this.makeChecks();
    } catch (err) {
      const error = err;
  ...
  async createConvert() {
    ...
    try {
      ...
      state10.gasPriceInUSD = this.calculateGasPriceInUSD(gas, gasPrice);
      return transaction;
    } catch (error) {
      return void 0;
    }
  ...
  getToTokenValues(amountBigInt, decimals) {
    ...
    const toTokenPrice = state10.tokensPriceMap[toTokenAddress] || "0";
  ...
  isInsufficientNetworkTokenForGas() {
    return NumberUtil.bigNumber(NumberUtil.bigNumber(state10.gasPriceInUSD || "0")).isGreaterThan(state10.networkBalanceInUSD);
  },
  setTransactionDetails(transaction) {
    ...
    state10.toTokenAmount = toTokenAmount;
    state10.toTokenPriceInUSD = toTokenPriceInUSD;
    state10.gasPriceInUSD = this.calculateGasPriceInUSD(transaction.gas, transaction.gasPrice);
    state10.priceImpact = this.calculatePriceImpact(state10.toTokenAmount, state10.gasPriceInUSD);
    state10.maxSlippage = this.calculateMaxSlippage();
  }
};
...
var AccountController = {
  ...
  setIsConnected(isConnected) {
    state11.isConnected = isConnected;
  },
  setCaipAddress(caipAddress) {
    state11.caipAddress = caipAddress;
    state11.address = caipAddress ? CoreHelperUtil.getPlainAddress(caipAddress) : void 0;
  },
  setBalance(balance, balanceSymbol) {
    state11.balance = balance;
    state11.balanceSymbol = balanceSymbol;
  },
  setProfileName(profileName) {
    state11.profileName = profileName;
  },
  setProfileImage(profileImage) {
    state11.profileImage = profileImage;
  },
  setAddressExplorerUrl(explorerUrl) {
    state11.addressExplorerUrl = explorerUrl;
  },
  setSmartAccountDeployed(isDeployed) {
    state11.smartAccountDeployed = isDeployed;
  },
  setCurrentTab(currentTab) {
    state11.currentTab = currentTab;
  },
  setTokenBalance(tokenBalance) {
    if (tokenBalance) {
      state11.tokenBalance = ref(tokenBalance);
    }
  },
  setConnectedWalletInfo(connectedWalletInfo) {
    state11.connectedWalletInfo = connectedWalletInfo;
  },
  setPreferredAccountType(preferredAccountType) {
    state11.preferredAccountType = preferredAccountType;
  },
  async fetchTokenBalance() {
    try {
      if (state11.address) {
        const response = await BlockchainApiController.getBalance(state11.address);
  ...
  resetAccount() {
    state11.isConnected = false;
    state11.smartAccountDeployed = false;
    state11.currentTab = 0;
    state11.caipAddress = void 0;
    state11.address = void 0;
    state11.balance = void 0;
    state11.balanceSymbol = void 0;
    state11.profileName = void 0;
    state11.profileImage = void 0;
    state11.addressExplorerUrl = void 0;
    state11.tokenBalance = [];
    state11.connectedWalletInfo = void 0;
    state11.preferredAccountType = void 0;
  }
};
...
var AssetController = {
  ...
  subscribeNetworkImages(callback) {
    return subscribe(state12.networkImages, () => callback(state12.networkImages));
  },
  subscribeKey(key, callback) {
  ...
  setWalletImage(key, value) {
    state12.walletImages[key] = value;
  },
  setNetworkImage(key, value) {
    state12.networkImages[key] = value;
  },
  setConnectorImage(key, value) {
    state12.connectorImages[key] = value;
  },
  setTokenImage(key, value) {
    state12.tokenImages[key] = value;
  },
  setCurrencyImage(key, value) {
    state12.currencyImages[key] = value;
  }
};
...
var ConnectorController = {
  ...
  setConnectors(connectors) {
    state14.connectors = connectors.map((c) => ref(c));
  },
  ...
  getEmailConnector() {
    return state14.connectors.find((c) => c.type === "EMAIL");
  },
  getAnnouncedConnectorRdns() {
    return state14.connectors.filter((c) => c.type === "ANNOUNCED").map((c) => {
      var _a5;
  ...
  getConnector(id, rdns) {
    return state14.connectors.find((c) => {
      var _a5;
...
var ApiController = {
  ...
  async fetchRecommendedWallets() {
    ...
    state15.recommended = data;
    state15.count = count ?? 0;
  },
  async fetchWallets({ page }) {
    var _a5;
    const { includeWalletIds, excludeWalletIds, featuredWalletIds } = OptionsController.state;
    const exclude = [
      ...state15.recommended.map(({ id }) => id),
      ...excludeWalletIds ?? [],
      ...featuredWalletIds ?? []
    ].filter(Boolean);
    const { data, count } = await api3.get({
    ...
    state15.wallets = [...state15.wallets, ...data];
    state15.count = count > state15.count ? count : state15.count;
    state15.page = page;
  },
  ...
  prefetch() {
    ...
    state15.prefetchPromise = Promise.race([Promise.allSettled(promises), CoreHelperUtil.wait(3e3)]);
  },
  ...
  async getQuote() {
    ...
    try {
      const quote = await BlockchainApiController.getOnrampQuote({
        ...
        amount: ((_a5 = state17.paymentAmount) == null ? void 0 : _a5.toString()) || "0",
        network: (_b3 = state17.purchaseCurrency) == null ? void 0 : _b3.symbol
      });
...
WuiOnRampActivityItem.styles = [resetStyles, elementStyles, styles_default55];
__decorate55([
  property({ type: Boolean })
...
WuiOnRampActivityItem = __decorate55([
...
WuiOnRampProviderItem.styles = [resetStyles, elementStyles, styles_default56];
__decorate56([
  property({ type: Boolean })
...
WuiOnRampProviderItem = __decorate56([
...
WuiPromo.styles = [resetStyles, elementStyles, styles_default57];
__decorate57([
  property()
], WuiPromo.prototype, "text", void 0);
WuiPromo = __decorate57([
...
WuiBalance.styles = [resetStyles, styles_default58];
__decorate58([
  property()
...
WuiProfileButton.styles = [resetStyles, elementStyles, styles_default59];
__decorate59([
  property()
...
WuiListToken.styles = [resetStyles, elementStyles, styles_default63];
__decorate63([
  property()
...
WuiListDescription.styles = [resetStyles, elementStyles, styles_default64];
__decorate64([
  property()
...
WuiListDescription = __decorate64([
...
WuiInputAmount.styles = [resetStyles, elementStyles, styles_default65];
__decorate65([
  property({ type: Boolean })
...
WuiPreviewItem.styles = [resetStyles, elementStyles, styles_default66];
__decorate66([
  property()
...
WuiGrid.styles = [resetStyles, styles_default67];
__decorate67([
  property()
...
WuiSeparator.styles = [resetStyles, styles_default68];
__decorate68([
  property()
], WuiSeparator.prototype, "text", void 0);
WuiSeparator = __decorate68([
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-F3GEAF3W.js.map
