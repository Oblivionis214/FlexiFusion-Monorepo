...
__export(lib_exports, {
  LABEL_TYPE_MENU_LABELS: () => LABEL_TYPE_MENU_LABELS,
  NotifiFrontendClient: () => NotifiFrontendClient,
  ...
  createInMemoryStorageDriver: () => createInMemoryStorageDriver,
  createLocalForageStorageDriver: () => createLocalForageStorageDriver,
  ensureDiscord: () => ensureDiscord,
  ensureEmail: () => ensureEmail,
  ensureSms: () => ensureSms,
  ensureSourceAndFilters: () => ensureSourceAndFilters,
  ensureTarget: () => ensureTarget,
  ensureTelegram: () => ensureTelegram,
  ensureWebhook: () => ensureWebhook,
  envUrl: () => envUrl,
  newFrontendClient: () => newFrontendClient,
  newFrontendConfig: () => newFrontendConfig,
  newNotifiService: () => newNotifiService,
...
var import_notifi_graphql = require("@notifi-network/notifi-graphql");
...
var newNotifiService = (config) => {
  ...
  return new import_notifi_graphql.NotifiService(client);
};
