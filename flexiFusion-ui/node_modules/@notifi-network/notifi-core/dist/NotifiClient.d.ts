...
export declare type AlertFrequency = 'ALWAYS' | 'SINGLE' | 'QUARTER_HOUR' | 'HOURLY' | 'DAILY' | 'THREE_MINUTES';
export declare type ThresholdDirection = 'above' | 'below';
export declare type ValueItemConfig = Readonly<{
    key: string;
    op: 'lt' | 'lte' | 'eq' | 'gt' | 'gte';
    value: string;
}>;
 ...
 */
export declare type BeginLoginViaTransactionResult = Readonly<{
    logValue: string;
}>;
/**
 ...
 */
export declare type CompleteLoginViaTransactionInput = Readonly<{
 ...
 *
 */
export declare type CompleteLoginViaTransactionResult = Readonly<User>;
/**
...
export declare type ClientCreateWebhookParams = Omit<CreateWebhookTargetInput, 'name'>;
/**
 ...
 * See [Alert Creation Guide]{@link https://notifi-network.github.io/notifi-sdk-ts/} for more information on creating Alerts
 */
export declare type ClientCreateMetaplexAuctionSourceInput = Readonly<{
 ...
 * See [Alert Creation Guide]{@link https://notifi-network.github.io/notifi-sdk-ts/} for more information on creating Alerts
 */
export declare type ClientCreateBonfidaAuctionSourceInput = Readonly<{
    auctionAddressBase58: string;
    auctionName: string;
}>;
/**
 ...
 * <br>
 */
export declare type ClientEnsureTargetGroupInput = Readonly<{
    name: string;
    emailAddress: string | undefined;
    phoneNumber: string | undefined;
    telegramId: string | undefined;
 ...
 */
export declare type ClientEnsureSourceGroupInput = Readonly<{
    name: string;
 ...
 */
export declare type ClientSendVerificationEmailInput = Readonly<{
    targetId: string;
}>;
export declare type ClientBroadcastMessageInput = Readonly<{
    topic: UserTopic;
    subject: string;
    message: string;
...
export declare type ClientFetchSubscriptionCardInput = Omit<FindTenantConfigInput, 'tenant'>;
export declare type Uint8SignMessageFunction = (message: Uint8Array) => Promise<Uint8Array>;
export declare type AptosSignMessageFunction = (message: string, nonce: number) => Promise<string>;
declare type hexString = `0x${string}`;
export declare type AcalaSignMessageFunction = (acalaAddress: string, message: string) => Promise<hexString>;
export declare type SignMessageParams = Readonly<{
...
export declare type WalletParams = Readonly<{
    walletBlockchain: 'SOLANA';
...
export declare type WalletWithSignMessage = Readonly<{
    walletBlockchain: 'SOLANA';
    walletPublicKey: string;
    signMessage: Uint8SignMessageFunction;
}> | Readonly<{
...
export declare type WalletWithSignParams = Readonly<{
    displayName?: string;
}> & WalletWithSignMessage;
export declare type ConnectWalletParams = Readonly<{
...
export declare type NotifiClient = Readonly<{
    ...
    broadcastMessage: (input: ClientBroadcastMessageInput, signer: SignMessageParams) => Promise<string | null>;
    completeLoginViaTransaction: (input: CompleteLoginViaTransactionInput) => Promise<CompleteLoginViaTransactionResult>;
    ...
    createBonfidaAuctionSource: (input: ClientCreateBonfidaAuctionSourceInput) => Promise<Types.SourceFragmentFragment>;
    deleteAlert: (input: ClientDeleteAlertInput) => Promise<string>;
    getConfiguration: () => Promise<ClientConfiguration>;
    getFusionNotificationHistory: (input: GetFusionNotificationHistoryInput) => Promise<Types.GetFusionNotificationHistoryQuery['fusionNotificationHistory']>;
    getNotificationHistory: (input: GetNotificationHistoryInput) => Promise<NotificationHistory>;
    ...
    ensureTargetGroup: (input: ClientEnsureTargetGroupInput) => Promise<TargetGroup>;
    ...
    markFusionNotificationHistoryAsRead: (input: Types.MarkFusionNotificationHistoryAsReadMutationVariables) => Promise<Types.MarkFusionNotificationHistoryAsReadMutation['markFusionNotificationHistoryAsRead']>;
}>;
export {};
